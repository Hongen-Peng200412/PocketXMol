...
- [T1-RA训练](../../../日志/第一类实验（不加密度信息）/03-B-C-T1-RA.md)、[T1-RA测试评价](../../../日志/第一类实验（不加密度信息）/05-B-C-T1-RA推理与评价.md)、[T1-RB训练](../../../日志/第一类实验（不加密度信息）/06-B-C-T1-RB.md)。
- [已完成T0报告](../../../日志/第一类实验（不加密度信息）/04-B-C-T0-RA推理与评价.md)及三份9-8契约、训练与运行/README.md。
