...
- [T0测试与取消验证记录](../../../日志/第一类实验（不加密度信息）/04-B-C-T0-RA推理与评价.md)：当前正式命令、取消证据、预算、版本与运行来源。
- [T0修复和训练结果](../../../日志/第一类实验（不加密度信息）/02-T0中心契约修复与重训.md)、[T1预登记](../../../日志/第一类实验（不加密度信息）/03-B-C-T1-RA.md)、[总日志](../../../日志/总日志.md)、[计划映射](../../../日志/计划执行映射.md)。
