...
当前状态以[总日志](../../../日志/总日志.md)、[第4实验日志](../../../日志/第一类实验（不加密度信息）/4-B-C-T0-RB.md)和[第6实验日志](../../../日志/第一类实验（不加密度信息）/6-B-E-T0-RB.md)为准，当前实现对应关系见[计划执行映射](../../../日志/计划执行映射.md)。沿用现行七份实验日志，不恢复旧文件；每次检查有新进度就更新对应实验与总日志，普通等待不写handoff。
