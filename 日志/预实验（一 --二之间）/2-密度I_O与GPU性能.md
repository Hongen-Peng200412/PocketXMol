...
2026-09-14 17:56状态：距离开关配对完成，D1增加0.97%、D4为-0.23%，均低于10%界限，统一保留distance_bias=true。D1当前选72×1，D4选36×2；D4的72×1反向OOM、0完整更新已排除。root采样门控第一次仅因归档shell含CRLF未进入pytest，已转换shell换行并开始重试；随后为D1运行两个60更新的新随机前缀供数窗口。D4另保留48更新持续窗口，不由现有16次短窗替代。
