...
2026-09-14 17:40状态：D1暂选72×1，已完成24更新，热态1.366秒、显存66.21GB；D4暂选36×2，已完成16更新，热态4.590秒、GPU97.55%、显存66.25GB。D4的72×1首次forward通过但反向OOM，0完整更新，已排除。当前先验收主代理0a9c849完整归档的真实Flash采样缓存修复，再按同批量/样本前缀比较距离开关；之后执行超过预取容量的新样本供数窗口。尚未形成最终距离及I/O选择。
