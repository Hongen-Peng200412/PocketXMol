...
2026-09-14 17:28状态：D1的24×3、36×2、72×1均完成24更新，热态平均分别1.614、1.477、1.366秒，已分配显存26.63、38.19、66.21GB；72×1暂为最快稳定计算组合，后续须经过超过预取容量的新样本窗口确认供数。D4第9次24×3完成16更新，热态4.697秒、GPU97.10%、等待0.018%、显存44.36GB；36×2与72×1仍在执行。A800已明确核对highest/medium两种贴边几何，12 passed。距离开关比较及最终I/O长窗口尚未完成。
