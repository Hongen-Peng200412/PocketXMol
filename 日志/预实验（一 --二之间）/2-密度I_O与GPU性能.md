...
2026-09-14 18:00状态：root 0a9c849的实际A800采样门控4 passed/19.43秒、无skip，D1/D4×sdpa/Flash全部执行。距离项已按D1增加0.97%、D4为-0.23%的配对结果统一保留。D1当前选72×1，D4选36×2；D4的72×1反向OOM、0完整更新已排除。当前D1第19次正在新的完整训练前缀上执行60更新供数窗口，之后运行第20次32 worker窗口；D4另保留48更新持续窗口，不由16次短窗替代。
