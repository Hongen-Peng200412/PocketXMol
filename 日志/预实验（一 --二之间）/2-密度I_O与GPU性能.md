...
2026-09-14 18:15状态：实际A800采样门控4 passed、无skip；距离项按完整AdamW配对结果统一保留。D1选72×1，D4选36×2；D4的72×1反向OOM、0完整更新已排除。D1第19/20次分别以15/32 worker完成60更新，暖态均值2.88948/1.96571秒，等待53.36%/29.21%，均未达到持续供数目标；当前选32 worker。接下来执行D1/D4包络实际入口及D4的48更新持续窗口，第24次仅测试进程局部MADV_RANDOM读取建议，不清系统缓存或修改资产。
