...
2026-09-14 18:22状态：实际A800采样门控4 passed、无skip；距离项按完整AdamW配对结果统一保留。D1选72×1，D4选36×2，均32 worker；D4的72×1反向OOM、0完整更新已排除。D1的60更新持续窗口暖态均值1.96571秒、等待29.21%，未达到持续供数目标。D1-E与D4-E均已完成4次真实完整更新，参数有限；第23次D4-C的48更新持续窗口正在执行。第24次仅测试进程局部MADV_RANDOM读取建议，不清系统缓存或修改资产。
