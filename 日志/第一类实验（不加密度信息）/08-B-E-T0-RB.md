...
依据为[科学契约](../../想法/方案草稿/9-8-科学契约.md)、[工程细节](../../想法/方案草稿/9-8-工程与实现细节.md)和[边界清单](../../想法/方案草稿/9-8-边界与核查清单.md)。当前登记训练配置、正式命令和产物位置，实际启动及完成证据在后续记录。
...
本实验沿用已批准的E-T0-RB配置与空E规则，没有新增科学条件。实际训练、测试及评价仍待完成。
