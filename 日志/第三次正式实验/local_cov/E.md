...
2026-09-20 10:23状态快照：正式训练已推进至约22351次优化器更新；第21600步验证没有刷新模型选择best，并触发第二次学习率下降，学习率由`2e-5`降至`4e-6`、下降计数为2。best仍为step16800、`val/loss=1.4467853307724`。训练日志持续更新，无OOM、Traceback或非有限值；空E口袋继续按既定规则跳过并记录，379402仍处于运行态。
...
| best与`val/loss` | 当前best为`step=16800.ckpt`，1.4467853307724 |
