...
2026-09-17 21:15状态快照：正式训练已推进至约2416次优化器更新；第2400步验证完成，当前best仍为step1600、`val/loss=1.6923410892486572`。训练日志持续更新，无OOM、Traceback或非有限值；空E口袋继续按既定规则跳过并记录，379402仍处于运行态。
