...
2026-09-18 03:23状态快照：正式训练已推进至约4329次优化器更新；第4000步验证把当前best刷新为step4000、`val/loss=1.650253415107727`。训练日志持续更新，无OOM、Traceback或非有限值；空E口袋继续按既定规则跳过并记录，379402仍处于运行态。
