...
2026-09-20 20:43状态快照：正式训练已推进至约25804次优化器更新。第25600步`val/loss=1.4752132892608643`，没有刷新模型选择best；best仍为`step=24800.ckpt`、1.4366419315338135。学习率保持`4e-6`、下降计数2、连续未达相对1%改善要求5次。训练日志持续更新，无OOM、Traceback或非有限值；若第26400步仍不满足改善阈值，将触发第三次下降并立即停止。
