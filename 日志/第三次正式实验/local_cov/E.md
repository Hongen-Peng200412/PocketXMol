...
2026-09-17 14:44状态快照：379402于14:36:20使用release`PocketXMol_ef9dd39`从官方参数重启，已推进至约8次更新。训练为72×1、bf16-mixed；观察时显存64,755 MiB、GPU利用率96%，未见OOM、Traceback或非有限损失；空E口袋继续按既定规则跳过并记录。
