...
2026-09-19 18:54状态快照：正式训练已推进至约21938次优化器更新；第21600步验证没有刷新模型选择best，best仍为step16800、`val/loss=1.6137449741363525`，并按契约完成第二次学习率下降：`2e-5→4e-6`，下降计数2。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
