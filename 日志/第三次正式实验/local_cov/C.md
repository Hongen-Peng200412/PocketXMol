...
2026-09-19 14:49状态快照：正式训练已推进至约20140次优化器更新；第20000步验证已完成，模型选择best仍为step16800、`val/loss=1.6137449741363525`。学习率保持`2e-5`、下降计数1、连续未达相对1%改善要求4次。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
