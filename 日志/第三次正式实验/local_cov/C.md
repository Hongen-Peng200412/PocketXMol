...
2026-09-18 23:34状态快照：正式训练已推进至约13722次优化器更新；第13600步验证把模型选择best刷新为step13600、`val/loss=1.6606634855270386`。学习率保持`2e-5`、下降计数1；该次改善仍未达到调度器的相对1%阈值，当前连续未达要求1次。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
...
| best与`val/loss` | 当前best为`step=13600.ckpt`，1.6606634855270386 |
