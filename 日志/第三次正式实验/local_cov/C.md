...
2026-09-18 18:27状态快照：正式训练已推进至约11876次优化器更新；最近完成的第11200步验证没有刷新当前best，best仍为step8000、`val/loss=1.6748944520950317`。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
