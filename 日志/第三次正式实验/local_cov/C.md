...
2026-09-18 00:20状态快照：正式训练已推进至约4162次优化器更新；第4000步验证把当前best刷新为step4000、`val/loss=1.9091085195541382`。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
...
| best与`val/loss` | 当前best为`step=4000.ckpt`，1.9091085195541382 |
