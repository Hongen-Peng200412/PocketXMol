...
2026-09-18 01:51状态快照：正式训练已推进至约4815次优化器更新；第4800步验证把当前best刷新为step4800、`val/loss=1.9076017141342163`。训练日志持续更新，无OOM、Traceback或非有限值；378693仍处于运行态。
...
| best与`val/loss` | 当前best为`step=4800.ckpt`，1.9076017141342163 |
