...
当前状态（2026-09-16 15:44—15:46）：official-SMILES：C0完整446实例已处理，445成功、1预处理失败；C5处理308/446实例，307成功、1预处理失败；失败均为9qkz/0，保留分母；E待开始。
...
| best／W&B／指标 | official-SMILES：C0完整446实例已处理，445成功、1预处理失败；C5处理308/446实例，307成功、1预处理失败；失败均为9qkz/0，保留分母；E待开始 |
