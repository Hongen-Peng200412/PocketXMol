...
当前状态（2026-09-16 18:51—18:53）：official-SMILES：C0/C5各446实例全部处理，各445成功、9qkz/0预处理失败且保留分母；E完成222/446实例、11100候选全部成功。
...
| best／W&B／指标 | official-SMILES：C0/C5各446实例全部处理，各445成功、9qkz/0预处理失败且保留分母；E完成222/446实例、11100候选全部成功 |
